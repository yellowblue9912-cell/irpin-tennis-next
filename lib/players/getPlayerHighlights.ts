...
const highlightsByPlayer: Record<string, PlayerHighlight[]> = {
  "viacheslav-hunin": [
    {
      id: "viacheslav-hunin-highlight-1",
      type: "video",
      src: "/highlights/viacheslav-hunin-1.mp4",
      title: "Відео за участі В’ячеслава Гуніна",
      description: "В’ячеслав грає у червоному.",
    },
  ],
  "olia-kulishenko": [
    {
      id: "olia-kulishenko-highlight-1",
      type: "video",
      src: "/highlights/olia-kulishenko-1.mp4",
      title: "Відео за участі Олі Кулішенко",
    },
  ],
  "sasha-havrysh": [
    {
      id: "sasha-havrysh-highlight-1",
      type: "video",
      src: "/highlights/sasha-havrysh-1.mp4",
      title: "Відео за участі Олександра Гавриша",
      description: "Олександр грає у червоному.",
    },
  ],
  "anton-rohov": [
    {
      id: "anton-rohov-highlight-1",
      type: "video",
      src: "/highlights/anton-rohov-1.mp4",
      title: "Відео за участі Антона Рогова",
      description: "Антон приймає подачу.",
    },
  ],
  "yurii-klymenko": [
    {
  ...
  "dmytro-khmel": [
    {
      ...
      type: "video",
      src: "/highlights/dmytro-khmel-1.mp4",
      title: "Відео за участі Дмитра Хміля",
      description: "Дмитро виконує подачу.",
    },
  ],
  "oleksandr-kavylin": [
    {
