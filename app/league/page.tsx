...
const leagues = [
  ...
  },
  {
    ...
    rating: "Усі рівні",
    description:
      "Окрема тенісна ліга для жінок, де можна знайти суперниць свого рівня, грати матчі та брати участь у турнірах.",
    purpose:
      "Мета ліги — розвивати жіночий теніс у нашій спільноті та створювати дружню, але конкурентну атмосферу.",
    features: [
      "Матчі між гравчинями різного рівня",
      "Окремий жіночий рейтинг",
      "Жіночі турніри та зустрічі",
    ],
    accent: "bg-[#e8b4c8]",
    button: "bg-[#123f2d] text-white",
  },
