...
const coaches: Coach[] = [
  ...
  },
  {
    ...
    audience:
      "Представник ГО «Федерація тенісу Ірпеня», головний тренер Andriyovych Irpin Club та тренер Energy Tennis Club. Готує дітей до участі в турнірах Федерації тенісу України, а також надає базову підготовку для участі в турнірах.",
    formats: [
      "Підготовка дітей до турнірів ФТУ",
      "Базова підготовка до участі в турнірах",
    ],
